...
plot([1: ceil(maxIter/itersPerDay)], infectedPerDay, 'LineWidth', 1);
xlabel('Dzieñ');
ylabel('Wartoœæ');
...
plot(days, totalInfected, 'LineWidth', 1);
xlabel('Dzieñ');
ylabel('Wartoœæ');
title('Ca³kowita liczba zachorowañ');

f6 = figure('Name','Active Cases','NumberTitle','off');
plot(days, activeCases, 'LineWidth', 1); hold on;
plot(days, totalRecovered, 'LineWidth', 1);
plot(days, totalDeaths, 'LineWidth', 1);
plot(days, totalConfirmed, 'LineWidth', 1);
legend('Active', 'Recovered', 'Deaths', 'Confirmed');
xlabel('Dzieñ');
ylabel('Wartoœæ');

f7 = figure('Name','In hospital','NumberTitle','off');
plot(days, totalInHospital, 'LineWidth', 1);
xlabel('Dzieñ');
ylabel('Wartoœæ');
title('Iloœæ chorych w szpitalu');
